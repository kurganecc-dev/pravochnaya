...
В верхней панели сервиса добавлено переключение между разделами **Правки** и **Бриф**. Бриф работает на той же странице и не требует отдельного сайта.

Форма содержит 16 вопросов продакшена:

- контакты и согласующие;
- тип, цель и стилистика ролика;
- аудитория, хронометраж и референсы;
- локации, инфографика и озвучка;
- ориентация, сроки, бюджет и сценарий;
- необязательное разрешение итогового файла.

Ответы автоматически:

- сохраняются локально в браузере;
- собираются в единый текст в правой колонке;
- копируются одной кнопкой;
- скачиваются как TXT;
- восстанавливаются после перезагрузки страницы.

Варианты выбора составлены по реальным заявкам продакшена. Тип ролика, стилистика, ориентация и разрешение поддерживают несколько вариантов, а для инфографики и бюджета предусмотрены уточнения.
